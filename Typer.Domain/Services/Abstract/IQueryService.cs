...
namespace Typer.Domain.Services
{
    public interface IQueryService
    {
        ...
        Query GetQueryWithDetails(int id);
        ...
        bool AddQuery(Query question);
        //IEnumerable<QuestionOption> GetOptions(int questionId);
        //IEnumerable<QuestionOption> GetOptions(int questionId, int[] languages);
        IEnumerable<Category> GetCategories(int queryId);
        IEnumerable<Query> Filter(int lowWeight, int upWeight, int[] categories, string text);
